      ...
      <section className="mt-8 rounded-[40px] border border-[#b9d0ff] bg-[linear-gradient(180deg,#dcebff_0%,#eef4ff_100%)] shadow-[0_24px_70px_rgba(35,62,124,0.08)] dark:border-[#283554] dark:bg-[linear-gradient(180deg,#1f2739_0%,#171e2d_100%)] dark:shadow-[0_24px_70px_rgba(3,8,20,0.45)]">
        <div className="grid gap-0 xl:grid-cols-[minmax(0,1fr)_340px]">
          <div className="px-6 py-8 sm:px-8 md:px-12 md:py-12">
            ...
            <div className="mt-10 rounded-[34px] bg-[linear-gradient(180deg,#eef4ff_0%,#e5eefc_100%)] px-4 py-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] dark:bg-[linear-gradient(180deg,#232d42_0%,#1a2234_100%)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] sm:px-6 md:px-8">
          ...
          <aside className="border-t border-[#c9daf8] px-4 py-6 xl:border-l xl:border-t-0 xl:px-5 xl:py-5 dark:border-[#2d3851]">
            <div className="flex flex-col gap-5">
              <div className="rounded-[18px] border border-[#234bc9] bg-[linear-gradient(180deg,#2f5ef0_0%,#2a4ec8_100%)] px-6 py-11 text-center text-white shadow-[0_18px_36px_rgba(29,80,215,0.24)]">
                <p className="text-[42px] font-semibold leading-[1.02] sm:text-[54px]">
                  Advertise
                  <br />
                  Here
                </p>
                <p className="mt-8 text-[32px] font-medium sm:text-[44px]">300 × 600</p>
              ...
              <div className="rounded-[18px] border border-[#234bc9] bg-[linear-gradient(180deg,#2f5ef0_0%,#2a4ec8_100%)] px-6 py-9 text-center text-white shadow-[0_16px_32px_rgba(29,80,215,0.22)]">
                <p className="text-[18px] text-white/88">Sponsored</p>
                <p className="mt-5 text-[34px] font-semibold leading-[1.05] sm:text-[44px]">
                  Advertise Here
                </p>
              ...
              <div className="rounded-[16px] border border-[#234bc9] bg-[linear-gradient(180deg,#2f5ef0_0%,#2a4ec8_100%)] px-5 py-7 text-center text-white shadow-[0_14px_28px_rgba(29,80,215,0.2)]">
                <p className="text-[16px] text-white/88">Sponsored</p>
                <p className="mt-4 text-[28px] font-semibold leading-[1.08] sm:text-[36px]">
                  Advertise Here
                </p>
                <p className="mt-5 text-[22px] font-medium sm:text-[30px]">300 × 300</p>
                <Link
                  href="/contact"
                  className="mt-7 inline-flex items-center gap-2 rounded-full bg-[#f4cd64] px-5 py-2.5 text-[15px] font-semibold text-[#17306b] transition hover:-translate-y-1"
                >
                  Advertise Here
                  <ArrowRight className="h-4 w-4" />
                </Link>
